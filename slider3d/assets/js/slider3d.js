...
function slider3d() {
	...
	function transformFunction() {
		...
		if (scaleValue1 <= 3) {
			...
			wrapper.find("box").css("pointer-events", "all");
			wrapper2.find("box").css("pointer-events", "all");
			...
			wrapper.find("box").css("pointer-events", "none");
			wrapper2.find("box").css("pointer-events", "none");
		}
